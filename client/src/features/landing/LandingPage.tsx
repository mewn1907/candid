          ...
          <div className="absolute left-4 sm:left-12 top-6 w-52 sm:w-64 polaroid-frame animate-drift-slow z-10">
            ...
            <div className="aspect-[4/3] bg-paper-300 rounded overflow-hidden relative shadow-inner">
              <div className="w-full h-full bg-gradient-to-tr from-clay/30 via-paper-200 to-cream flex items-center justify-center relative overflow-hidden">
                ...
                <svg className="absolute top-2 right-10 w-7 h-7 text-clay/12" viewBox="0 0 28 28" fill="none" aria-hidden="true"><circle cx="14" cy="14" r="6" stroke="currentColor" strokeWidth="0.9" strokeDasharray="2 2"/><path d="M14 8 L14 12 M14 16 L14 20 M8 14 L12 14 M16 14 L20 14" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round"/></svg>
                <svg className="absolute bottom-3 left-2 w-9 h-9 text-pine/12" viewBox="0 0 32 32" fill="none" aria-hidden="true"><path d="M8 20 C12 12 16 16 20 12 C24 8 26 14 22 20 C18 26 12 26 8 20Z" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/><path d="M20 12 L24 8" stroke="currentColor" strokeWidth="0.9" strokeLinecap="round"/></svg>
                <svg className="absolute top-8 left-1/2 -translate-x-1/2 w-10 h-3 text-ink-700/10" viewBox="0 0 40 12" fill="none" aria-hidden="true"><path d="M2 6 C10 2 18 10 26 6 C30 4 36 6 38 6" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeDasharray="3 3"/></svg>
          ...
          <div className="absolute right-4 sm:right-12 top-12 w-52 sm:w-64 polaroid-frame animate-drift-alt z-20">
            ...
            <div className="aspect-[4/3] bg-paper-300 rounded overflow-hidden relative shadow-inner">
              <div className="w-full h-full bg-gradient-to-tl from-pine/25 via-paper-200 to-cream flex items-center justify-center relative overflow-hidden">
                ...
                <svg className="absolute top-1/2 right-1.5 w-8 h-8 text-clay/12" viewBox="0 0 32 32" fill="none" aria-hidden="true"><path d="M10 14 C14 10 18 14 22 18 C18 22 14 22 10 18" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/><circle cx="14" cy="14" r="1" fill="currentColor"/><circle cx="20" cy="16" r="1" fill="currentColor"/></svg>
                <svg className="absolute bottom-1 right-10 w-10 h-3 text-pine/12" viewBox="0 0 40 12" fill="none" aria-hidden="true"><path d="M2 6 Q10 2 20 6 T38 6" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeDasharray="3 3"/></svg>
                <svg className="absolute top-8 left-3 w-6 h-10 text-ink-700/10" viewBox="0 0 24 40" fill="none" aria-hidden="true"><path d="M12 4 C10 10 12 16 14 22 C12 26 10 30 12 36" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeDasharray="2 3"/></svg>
                <div className="text-center p-3 relative z-10">
